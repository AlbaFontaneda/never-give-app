...
public class TricepsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(TricepsActivity.this, TrainingActivity.class));
            }
        });

        String[] tricepsExercises = getResources().getStringArray(R.array.all_exercises_titles);

        final TextView textUno = findViewById(R.id.ejercicioUnoText);
        textUno.setText(tricepsExercises[11]);

        final TextView textDos = findViewById(R.id.ejercicioDosText);
        textDos.setText(tricepsExercises[12]);
        ...
        continuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (numSeries.matches("") || numRepeticiones.matches("") || tiempoDescanso.matches("")) {
                    Toast.makeText(TricepsActivity.this,
    ...
    public void onBackPressed() {
        Intent setIntent = new Intent(TricepsActivity.this, ExercisesTypeActivity.class);
