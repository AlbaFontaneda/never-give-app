...
public class FoodsActivityAntiguo extends MainActivity
        implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_foods_antiguo);
        //Finds ID
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                Intent intent = new Intent(FoodsActivityAntiguo.this, MainActivity.class);
    ...
    @Override
    public void onClick(View v) {
        /*Toast.makeText(FoodsActivityAntiguo.this,
